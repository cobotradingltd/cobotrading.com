...
export const metadata: Metadata = {
  title: 'Blog',
  description:
    'Stay informed and inspired with the latest insights from the world of global trade. Our blog covers industry trends, expert tips, and innovative strategies to help businesses thrive in the competitive B2B landscape.',
}
